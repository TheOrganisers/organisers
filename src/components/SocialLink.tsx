...
const SocialLink: React.FC<SocialLinkProps> = ({ platform, url }) => {
  return (
    <a
      ...
      className="group flex items-center gap-2 px-6 py-3 rounded-full transition-all duration-300 hover:bg-white/5 border border-white/10 hover:border-premium-gold/30"
    >
      {platform === 'instagram' && (
